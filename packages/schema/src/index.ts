export const DRILL_RUN_SCHEMA_VERSION = "0.9" as const;
export const DRILL_PACK_SCHEMA_VERSION = "0.12" as const;
export const SHAPE_ENTRY_SCHEMA_VERSION = "0.1" as const;
