// Canonical JSON + synchronous SHA-256 (browser and server compute identical digests). Split out of
// assistance-exchange.ts (2026-09-24) so the campaign encounter receipt can seal with the same
// digest without an import cycle; assistance-exchange.ts re-exports both names unchanged.
