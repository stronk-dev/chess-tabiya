...
export const HINT_CEILING_TABLE = Object.freeze({
  ...
  presets: Object.freeze({ quiet: "off", guided: "distance", theory_only: "off", support: "distance", analysis: "off", campaign_kit: "distance" } satisfies Record<PresetId, HintDistance>),
