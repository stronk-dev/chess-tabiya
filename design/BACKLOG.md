...
| Streamer/Twitch mode | Real host board + chat voting + overlay + rewind/branch/compare scenario | #8 · overlay blocked on **F1** (withholding is per-run, not per-viewer) | `03-product-breadth.md`, `planning/breadth/live-and-platform.md` |
