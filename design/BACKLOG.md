...
| Opponent policy broker (theory_strict…strong_engine modes; policy mixer for coherence) | 📐 · feasibility = exploration **Q5** · DESIGN-GAPS 2026-08-12 **resolved same day** (run schema v0.4 typed selection payload; minimal maia3 policy-exposure patch in the sidecar — see `rfc/engine-workers.md` changelog) | `rfc/engine-workers.md` EW-C1/EW-C3, `arch/rfcs/RFC-0003` sketch, `arch/08` |
