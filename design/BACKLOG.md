...
| Breadth #2 split: authoring-contracts-v03 → evidence-composer (#2a) → explanation-surface (#2b) | 📜 RFC 2026-08-11. The composer review found claim triggers, executable window semantics, a boundary combinator, and a multi-source ref grammar all assumed-but-absent; they became a prerequisite amendment RFC rather than implementer improvisation | `rfc/authoring-contracts-v03.md`, `rfc/evidence-composer.md` |
