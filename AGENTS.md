...
implemented and documented in `docs/drill-pack-format.md`. `engine-workers` is the
active implementation RFC.
...
| RFC | `rfc/` | `engine-workers.md` implementing; completed foundations frozen in `rfc/archive/` |
