...
and documented in `docs/app-shell.md`; the next breadth-program RFC has not yet
...
| RFC | `rfc/` | No active product RFC; five implemented systems frozen in `rfc/archive/` |
