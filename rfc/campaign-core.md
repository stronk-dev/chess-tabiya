...
- **Status:** implementing — 2026-08-23 authored-contract + registry checkpoints. The closed campaign JSON schema, typed three-act document, exact ten-module unlock pool, pack/boss/economy/ceiling validator, version-retaining campaign registry, and eighth workflow context are implemented with negative fixtures. Persistence, play-run mutation, routes, seed content and surfaces remain; the migration stays behind the unresolved longitudinal-store and bot-policy positions. *(Prior line: accepted — 2026-08-22, by claude as register owner after independent cross-review and 15 in-place corrections. Before that: draft — 2026-08-22.)*
