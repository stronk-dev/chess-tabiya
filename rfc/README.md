...
| `evidence-contract-manifest.md` | **implementing — second author-return amendment accepted on buildability 2026-08-21; bind stage resumed.** [[D669]] distinguishes producer/computation, provider acquisition and consumer/delivery. [[D670]]–[[D677]] correct structural-source, reference-resolution, authored-claim, Explorer, comparison, sourcing-ledger and opponent-provider payload identities found while replacing anchors with real admitted consumers. The manifest now has 19 producers / 92 projections / 23 operations. Remaining work is the comparison-strip and story delivery boundaries, not an owner ruling. D667/D668 untouched | reconciles the evidence seams of six implemented RFCs | **claims nothing in the six shared-resource registers.** Declaration IDs are an extensible, independently versioned set; no pack/run/shape/principle schema or storage migration |
