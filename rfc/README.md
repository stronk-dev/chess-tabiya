...
| `live-surface-honesty.md` | **implementing** | — | **claims nothing versioned**. Makes `session.kind` behavioural at one read site; splits the assistance *ceiling* from the *preference* |
