...
| `graduation-clearance.md` | **returned to author 2026-08-16 after implementation review.** Four contract blockers are recorded in the body and as D464–D467: `ledger_record` has no record-kind discriminator; historical resolved subjects are not all representable; the automatic transition has no writer; and runtime `git blame` has no Git history in the production image. **Not implementation-ready.** | — | keeps its **pack schema 0.28** claim while returned. No migration, run-schema, or shape-entry claim |
...
| 0.28 | `graduation-clearance.md` | **claimed and held by a draft returned to author 2026-08-16** — the lane remains reserved while D464–D467 are corrected. No migration, run-schema, or shape-entry claim |
