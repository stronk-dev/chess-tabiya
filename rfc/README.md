...
| `evidence-contract-manifest.md` | **implementing — second author-return amendment accepted on buildability 2026-08-21; bind stage resumed.** [[D669]] distinguishes producer/computation, provider acquisition and consumer/delivery. [[D670]] separates authored structural input, direct feature results and total traced result; [[D671]] adds exact pack/shape source identity. [[D672]] stops family-only/checkpoint refs masquerading as full predicate/authored payloads. [[D673]] splits normalized guidance claims from full delivery-sheet claim items. The manifest now has 18 producers / 84 projections / 23 operations. Remaining work is real consumer-view wiring/type fixtures, not an owner ruling. D667/D668 untouched | reconciles the evidence seams of six implemented RFCs | **claims nothing in the six shared-resource registers.** Declaration IDs are an extensible, independently versioned set; no pack/run/shape/principle schema or storage migration |
