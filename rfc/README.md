...
| `return-and-progression.md` | implementing | `archive/drill-pack-format.md`, `archive/learner-identity-and-authorization.md` (F3), `archive/defect-sweep.md` | breadth program **#7**, gate **B7** — attempt scheduling and `/learn`. **Run schema unchanged**, migration **6**, pack schema 0.5 → 0.6 |
...
| 6 | 5→6 | `return-and-progression.md` | implementing — attempts, schedules, progress and position statistics; create-table/index only |
