...
RFC drafting is closed until the continuation gates in `planning/exploration/gates.md`
pass, or an owner ruling (logged in `planning/exploration/log.md`) opens a specific RFC
early. See the "Exploration gate" section of `0000-rfc-process.md`.
...
| License (and paid vs OSS product posture) | exploration Q2 | Marco | Gates any public release; AGPL/GPL deps constrain proprietary paths |
