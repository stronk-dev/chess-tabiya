...
- **Depends on:** `tactical-collectors.md` landing first (`legal-exchange@1`, compiled
  ...
  disclosed D754 pass device with its `invalid_turn_clone` abstention). Landing order is
  therefore **2c → 2d → 2e** and is normative
