...
export const ACTIVE_TRUTH = Object.freeze([
  ...
  { rfc: "graduation-clearance.md", registerState: "accepted", reality: "accepted_unbuilt", nextAction: "implement before its held pack lane can clear" },
  { rfc: "feedback-delivery.md", registerState: "accepted", reality: "accepted_stage1_dirty", nextAction: "reconcile the corrected CR1 instrument, then finish Stage 1 without claiming Stage 2" },
