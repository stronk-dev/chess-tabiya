...
const POSTCOMMIT = [
  ...
  "derived.grade.move_quality", "derived.tactic.fork_survives_reply",
  "derived.pawn.sequence.harassment_pressure", ...observed,
] as const;
...
export const AUTHOR_MODULE_ACCEPTS = Object.freeze({
  sight_on_request: Object.freeze([
    ...
    "rules.pawn.reading.contacts", "rules.mobility.reading.legal_moves",
  ]),
  ...
  review_map: Object.freeze([
    ...
    "run.record.imported_result", "derived.pawn.sequence.contact_timing",
  ...
  full_inspector: Object.freeze([
    ...
    "rules.mobility.reading.legal_moves", "rules.square.event.control",
    "rules.mobility.event.piece_destinations",
...
export const AUTHOR_PROJECTION_SUBJECT_OVERRIDES = Object.freeze({
  ...
  "derived.material.event.role_asymmetry": "edge",
  ...
  "derived.opening.deepest_reached": "run_prefix",
  "derived.pawn.sequence.contact_timing": "run_prefix",
  "derived.pawn.sequence.harassment_pressure": "run_prefix",
  ...
  "derived.tactic.fork_survives_reply": "edge",
  "derived.tactic.sequence.defender_consequence": "run_prefix",
  ...
  "rules.mobility.reading.legal_moves": "position",
  "rules.mobility.event.piece_destinations": "edge",
  ...
  "rules.square.event.control": "edge",
