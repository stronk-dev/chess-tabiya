// DISPOSABLE research harness — D629. Not production code.
...
export default defineConfig({
  ...
  test: { include: ["tools/detector-conformance-harness/*.test.ts"], testTimeout: 600000, disableConsoleIntercept: true },
});
