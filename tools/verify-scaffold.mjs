...
if (!/^verify: typecheck test schema-check register-check status-parity$/m.test(makefile)) {
  failures.push("Makefile: verify must depend on typecheck, test, schema-check, register-check, and status-parity");
}
