...
| `rules.pawn.reading.promotion_geometry@1` | position_rules | precommit_requested, postcommit, review, analysis | support, review, bot, inspector, authoring | square, relation, concept | local synchronous geometry; typed pass/reply availability; bounded one-reply flag |
