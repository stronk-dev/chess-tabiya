...
export const CAPABILITY_DISPOSITIONS: readonly CapabilityDisposition[] = Object.freeze([
  ...
  { instrument: "Explorer", capability: "topGames / recentGames / masters database", disposition: "unmeasured", reason: "Famous-game sourcing is approved; serialized retrieval, attribution, record-boundary stripping, and non-systematic-use safeguards await implementation", experiment: "rfc/famous-games.md acceptance and source/provenance integration fixtures" },
