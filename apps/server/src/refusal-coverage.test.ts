...
const trajectory = document("../../../content/drafts/trajectory-mate-bishop-knight.json");
const line = document("../../../content/drafts/anti-caro-advance.json");
const outcome = document("../../../content/drafts/rook-4v3-same-side.json");
