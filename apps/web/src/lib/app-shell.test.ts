...
describe("application shell", () => {
  ...
  it("deep-links to review, opens a run, and derives read-only before rendering", async () => {
    ...
    // Nine product destinations plus the persistent licence/source entry (rfc/verifiable-runtime-distribution.md §9).
    expect(document.querySelectorAll("nav a:not(.legal-link)")).toHaveLength(9);
