...
export interface LiveSessionSummary extends LiveSession { readonly board:{readonly activeFen:string;readonly objectiveState:ObjectiveState;readonly sideToMove:"white"|"black";readonly plyCount:number;readonly pausedAt:string|null;readonly leaseHeldBy:LeaseIdentity;readonly lastMoveAt:string|null;readonly players?:{readonly white:LeaseIdentity|null;readonly black:LeaseIdentity|null}};readonly match?:MatchState }
