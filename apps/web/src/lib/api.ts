...
export interface LiveSessionDetail { readonly session:LiveSession;readonly classroom?:{readonly id:string;readonly name:string};readonly role:RunRole;readonly activeNodeId:string;readonly leaseHeldBy:LeaseIdentity;readonly voteAdapter?:LeaseIdentity;readonly grants:readonly RunGrant[];readonly moveAuthorship:readonly MoveAuthorship[];readonly proposals:readonly SessionProposal[];readonly vote?:VoteTally;readonly invitations:readonly SessionInvitation[];readonly legs:readonly ArenaLeg[];readonly match?:MatchState;readonly marks:readonly RelayedMark[];readonly marksTruncated?:true }
