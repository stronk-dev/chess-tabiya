...
<style>
  .story{height:100%;min-height:0;display:grid;grid-template-rows:auto auto auto minmax(0,1fr) auto;gap:.75rem;padding:1rem;overflow:hidden}.story>header{grid-row:1;display:flex;justify-content:space-between;align-items:start;gap:1rem}.story>.share-management{grid-row:2}.story>.pending{grid-row:3}.story>.stage{grid-row:4}.story>.rail-region{grid-row:5}.story h1,.story h2,.story p{margin:.15rem 0}.eyebrow{text-transform:uppercase;letter-spacing:.09em;font-size:.75rem}.actions{display:flex;gap:.5rem;align-items:center}.pending{padding:.55rem .75rem;border:1px solid color-mix(in srgb,var(--ink) 30%,transparent);border-radius:.5rem}.share-management{display:grid;gap:.55rem;padding:.75rem;border:1px solid color-mix(in srgb,var(--ink) 25%,transparent);border-radius:.6rem;background:var(--panel)}.share-management h2{font-size:1rem}.share-management ul{display:grid;gap:.4rem;margin:.25rem 0 0;padding:0;list-style:none}.share-management li{display:flex;align-items:center;justify-content:space-between;gap:1rem;padding-top:.4rem;border-top:1px solid color-mix(in srgb,var(--ink) 18%,transparent)}.stage{min-height:0;display:grid;grid-template-columns:minmax(16rem,min(52vh,42vw)) minmax(18rem,1fr);gap:1.25rem;align-items:stretch;overflow:hidden}.board{height:min(52vh,100%);max-width:100%;aspect-ratio:1;justify-self:center;align-self:center}.moment-detail{min-height:0;max-height:100%;max-width:44rem;overflow-y:auto;overscroll-behavior:contain;padding-inline-end:.5rem}.evaluation{font-variant-numeric:tabular-nums}.provenance{color:var(--muted);font-size:.85rem}.reentry-frame{max-width:42rem;margin-top:.8rem!important;padding:.75rem;border-left:3px solid var(--accent);background:color-mix(in srgb,var(--accent) 7%,var(--panel));line-height:1.45}.rail-region{min-width:0}.moment-order,.selection-budget{color:var(--muted);font-size:.85rem;padding-inline:.25rem}.rail{display:flex;gap:.5rem;overflow-x:auto;list-style:none;padding:.25rem;margin:0}.rail button{min-width:10rem;display:grid;gap:.1rem;text-align:left;padding:.6rem;border:1px solid color-mix(in srgb,var(--ink) 25%,transparent);border-radius:.5rem;background:var(--panel)}.rail button.active{border-color:var(--ink)}.primary{margin-top:.75rem}@media(max-width:760px){.story{height:auto;grid-template-rows:repeat(5,auto);overflow:auto}.stage{grid-template-columns:1fr;overflow:visible}.board{width:min(80vw,55vh);height:auto}.moment-detail{max-height:none;overflow:visible;padding-inline-end:0}header{flex-direction:column}.share-management li{align-items:start;flex-direction:column}}
</style>
