...
3. **In progress:** Maia candidate WDL, legal-exchange-backed loose-piece state, ordered
   ray classification and role-matched development state/event are implemented; add the
   remaining structural and tactical collectors at the ten normative production sites.
