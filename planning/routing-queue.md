...
|---|---|---|
| D1713 | D1711 `semantic-validation-authority` author input | Consume the complete 67-row migration matrix: preserve 32 emitter positives and 5 emitter negatives; elevate 11 source-only negatives; supply the 35/51 positive/negative gaps; rule every orientation/counterfactual/population/external cell required or not-applicable; begin with the 14 authority-empty events. |
