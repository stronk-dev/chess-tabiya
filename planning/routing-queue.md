...
|---|---|---|
| D1724 | D1722 convention registry → semantic collector / D632 / learner-module author amendment | Consume the measured six-way boundary: current control, future-file challenge, capture migration, candidate, occupied and move-created named-piece challenge. Preserve exact operands, keep value/use separate, and dry-run/human-review all 23 expressions in three shape docs. |
