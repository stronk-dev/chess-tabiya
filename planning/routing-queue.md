...
| D1863, D1864, D1865, D1866, D1867, D1868, D1869 | `module-registration` second author amendment, coordinated with preset/presentation/provider/hint owners | Carry requested local help as untrusted input and return the server-clamped truth; replace the old projection string renderer with pair-keyed sealed components; define timing-complete evidence assembly; resolve pre/at-commit disclosure accounting; retire or narrowly justify the legacy arrows consumer; publish all eleven capability sets; validate every request token. Repeat independent review before implementation. |
