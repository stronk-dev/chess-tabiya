...
| 2c | Legal exchange + exact/identity-retaining collector Wave A: accepted RFC, implementation and external-population measurements | **RFC amended after prerequisite falsification and independent buildability review; acceptance remains pending and implementation remains blocked on acceptance plus the Phase-2b closure decision** | `rfc/tactical-collectors.md`, `design/research/legal-exchange-prerequisite.md` |
