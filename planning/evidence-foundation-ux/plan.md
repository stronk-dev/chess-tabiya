...
| 2b | Breadth closure beyond the first collector wave: square denial/restriction, pawn dynamics, activity/coordination, king/imbalance and multi-edge persistence; disposable probes + authored/imported-population measurements | **taxonomy + eleven one-edge probes + first sequence census landed; SEE/search-dependent semantics active** | `design/research/middlegame-evidence-and-style-taxonomy.md`, `tools/d723-breadth-harness/`, D723-D729, D746-D748 |
| 2c | SEE + exact/identity-retaining collector Wave A: accepted RFC, implementation and external-population measurements | blocked on 2b closure; owner convention/sign rulings answered | collector RFC + implementation |
