...
| 2b | Breadth closure beyond the first collector wave: square denial/restriction, pawn dynamics, activity/coordination, king/imbalance and multi-edge persistence; disposable probes + authored/imported-population measurements | **twenty-two one-edge probes + two sequence censuses + legal-exchange prerequisite landed; legal-vs-safe square and three-edge identity retention answered. Active residue: individual mobility beyond that square join, lever/passer conversion, king-state operands and counterfactual forcing-reply/search semantics** | `design/research/middlegame-evidence-and-style-taxonomy.md`, `design/research/legal-exchange-prerequisite.md`, `design/research/wave-b-breadth-probe.md`, `design/research/legal-square-denial.md`, `design/research/identity-retaining-three-edge-consequences.md`, `tools/d723-breadth-harness/`, `tools/d730-see-harness/`, `tools/d754-wave-b-harness/`, `tools/d771-legal-denial-harness/`, `tools/d772-three-edge-harness/`, D723-D773 |
