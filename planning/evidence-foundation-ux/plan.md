...
| 2b | Breadth closure beyond the first collector wave: square denial/restriction, pawn dynamics, activity/coordination, king/imbalance and multi-edge persistence; disposable probes + authored/imported-population measurements | **forty-five one-edge probes + two sequence censuses + legal-exchange prerequisite landed; legal-vs-safe square, three-edge identity, passed-pawn conversion, decomposed king state and exact piece mobility answered. Active residue: candidate passer/lever timing and counterfactual forcing-reply/search semantics** | `design/research/middlegame-evidence-and-style-taxonomy.md`, `design/research/legal-exchange-prerequisite.md`, `design/research/wave-b-breadth-probe.md`, `design/research/legal-square-denial.md`, `design/research/identity-retaining-three-edge-consequences.md`, `design/research/pawn-conversion-events.md`, `design/research/decomposed-king-state.md`, `design/research/identity-retaining-mobility.md`, `tools/d723-breadth-harness/`, `tools/d730-see-harness/`, `tools/d754-wave-b-harness/`, `tools/d771-legal-denial-harness/`, `tools/d772-three-edge-harness/`, `tools/d774-pawn-conversion-harness/`, `tools/d778-king-state-harness/`, `tools/d783-piece-mobility-harness/`, D723-D787 |
