...
| 2b | Breadth closure beyond the first collector wave: square denial/restriction, pawn dynamics, activity/coordination, king/imbalance and multi-edge persistence; disposable probes + authored/imported-population measurements | **taxonomy + eleven one-edge probes + first sequence census + legal-exchange prerequisite landed; bounded-search semantics and remaining breadth probes active** | `design/research/middlegame-evidence-and-style-taxonomy.md`, `design/research/legal-exchange-prerequisite.md`, `tools/d723-breadth-harness/`, `tools/d730-see-harness/`, D723-D730, D746-D753 |
| 2c | Legal exchange + exact/identity-retaining collector Wave A: accepted RFC, implementation and external-population measurements | **RFC amended after prerequisite falsification; independent buildability review pending; implementation remains blocked on acceptance and the Phase-2b closure decision** | `rfc/tactical-collectors.md`, `design/research/legal-exchange-prerequisite.md` |
