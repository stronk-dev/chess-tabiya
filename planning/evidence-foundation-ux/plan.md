...
| 2b | Breadth closure beyond the first collector wave: square denial/restriction, pawn dynamics, activity/coordination, king/imbalance and multi-edge persistence; disposable probes + authored/imported-population measurements | **twenty one-edge probes + first sequence census + legal-exchange prerequisite landed; stable positives/refusals recorded. Active residue: individual legal mobility, lever/passer conversion, king-state operands, forcing-reply/search semantics and ≥3-edge identity persistence** | `design/research/middlegame-evidence-and-style-taxonomy.md`, `design/research/legal-exchange-prerequisite.md`, `design/research/wave-b-breadth-probe.md`, `tools/d723-breadth-harness/`, `tools/d730-see-harness/`, `tools/d754-wave-b-harness/`, D723-D762 |
