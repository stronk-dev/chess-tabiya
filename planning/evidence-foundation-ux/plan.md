...
| 2b | Breadth closure beyond the first collector wave: square denial/restriction, pawn dynamics, activity/coordination, king/imbalance and multi-edge persistence; disposable probes + authored/imported-population measurements | **twenty-two one-edge probes + first sequence census + legal-exchange prerequisite landed; legal-vs-safe minor destination split answered and stable positives/refusals recorded. Active residue: individual mobility beyond that square join, lever/passer conversion, king-state operands, forcing-reply/search semantics and ≥3-edge identity persistence** | `design/research/middlegame-evidence-and-style-taxonomy.md`, `design/research/legal-exchange-prerequisite.md`, `design/research/wave-b-breadth-probe.md`, `design/research/legal-square-denial.md`, `tools/d723-breadth-harness/`, `tools/d730-see-harness/`, `tools/d754-wave-b-harness/`, `tools/d771-legal-denial-harness/`, D723-D772 |
