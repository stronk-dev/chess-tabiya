...
**Date:** 2026-08-22  
**Input:** `rfc/tactical-collectors.md` at `d7c30ab` plus lifecycle formatting commits  
**Evidence instrument:** `tools/d730-see-harness/`  
**Outcome:** amended draft; ready for an independent buildability review, **not accepted**
...
| Register/count claims were stale | The RFC said D718, “first free D745,” and 29 projections even after D745–D748 existed and opening identity was split | Ruling references use D745; fork is D749; Appendix A is a closed 28-id list |
...
The result does **not** prove that the Wave-A list is a complete middlegame ontology. The D723
breadth program remains active for square restriction, pawn dynamics, coordination, king/imbalance
relations, defender manipulation and multi-edge persistence. An independent reviewer should reject
the RFC if it turns this local-exchange result into move quality, strategic intent, a universal
ranking prior or a substitute for those missing families.

## Independent review checklist

1. Recompute Appendix A count and compare every id with its §3 semantics.
...
Only after that review may the owner accept the RFC and open implementation. Phase 2b breadth may
continue in parallel; collector implementation does not certify breadth closure.
