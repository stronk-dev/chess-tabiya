...
1. the capability-watch instrument;
2. prepare R11's matched blind multi-ply review set, then run it with external reviewers;
...
R3's mechanical/desk arm, R4, R5, R18's mechanical/code/desk arm and R12's short-session arm are complete. R18 proves the provider-off core but fails the present 1.0 platform floor and makes O13 ready; participant accessibility remains external. R12 supports continuous
