...
| `graduation-clearance` | implementing in body and register after [[D2396]] | `make graduation-clear`, clearance transitions, read-only planning and the named authoring codes shipped at `bcb706e0`; `ec52f61d` hardened the mechanism | Pack 0.28, emitter templates and Gate-F-held corpus application remain | **implementing**; continue from the shipped checkpoint rather than rebuilding it |
