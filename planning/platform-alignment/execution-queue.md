...
| 0.5 | Implement accepted incomplete RFC work | **PARTIAL — Feedback Stage 1 LANDED 2026-08-21; graduation author correction still gates its mechanism** | Feedback Stage 1 landed at `a64e6c5` with D643–D646 closed. D642 permits graduation's mechanism/read-only planner only after criterion 13 replaces the withdrawn lint code; D560 still gates the 92-document apply/archive. Feedback Stage 2 remains behind D560. Teacher waits on R15/O11 or amendment |
...
| 6B | F2 and F3 | Draft after F1; coordinate resource claims; land in declared order |
