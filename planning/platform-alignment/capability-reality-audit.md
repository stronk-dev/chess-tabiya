...
| Capability watch | **proven planning instrument** | Checked JSON register plus deterministic validator/summary | Queryable capability/product/evidence/dependency/route records | 21 canonical representative products across 18 capabilities; aliases remain aliases | Duplicate-URL, source, enum, love/hate-missingness, dependency/route, map-family and alias/new-capability controls pass | D556 closed. Residual is research, not machinery: 18/25 rows have neither love nor hate checked, and D554 owns targeted hands-on/forum work. |
