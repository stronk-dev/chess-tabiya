...
| F2 | **Semantic evidence and selector — IMPLEMENTED 2026-08-21 by `7944ecb`** | R1–R2/A3, O2–O3 and F1 complete | 33 operand-preserving events; research-only eligibility; complete local counterfactual population; deterministic reasons/budgets; exact adapters; retained authored/CC0 baselines | `rfc/archive/semantic-evidence-selection.md`; D630/D631/D633 closed, while D632 migration remains F3 |
| F2b | **Semantic consequence search and contrast proof** | D1066/D1363/D794/D1023/D1071 research; F1/F2; shared candidate packet/service/registry | Registered hypotheses over exact legal continuations; provider-line versus exact-bounded versus policy-coverage strength; perspective/polarity; witnesses/refutations/residual mass; contrastive selected-vs-alternative reasons; typed abstention; one shared service consumed by hints, Review, bots and pack validation | `rfc/semantic-consequence-search.md`; `design/research/semantic-consequence-search.md`; numerical profiles remain behind [[D3262]] |
...
| F5 | **Assistance modules, presets and interaction contract** | R3/R5/A5, O4, F2 accepted; proof-backed “why” modules additionally require F2b | Separate workflow/preset state from technical profile/source preferences; intent presets; per-session ceiling; preset ∩ workflow ∩ honesty/access ∩ availability composition; pre/post-commit rules; touch/hover/keyboard semantics; module budgets; LLM-off fallback; honest unavailable state; migrate six profiles without cross-workflow contamination | Amend `assistance-controls`; reuse `live-marker-quality` admission rules; [[D636]] is closed at the addressing layer; [[D3158]] remains the activation-layer Academy default mismatch |
| F6 | **Review Map, re-entry and social recap** | R7, O7, F2 accepted; proof-backed move reasons require F2b; F4 optional only for cited theory modules | Moment selection; engine-label boundary; replay/branch/drill links; grounded share packet; deterministic fallback; longitudinal focus excluded until F9 | New or amend game-story RFC lineage after A0 |
...
| F8 | **Bot policy/personality** | R11, O8, F1/F2 accepted; semantic-reason weighting/explanation additionally requires F2b | Separate strength/repertoire/style/error/time/memory/voice; calibration; information boundary; deterministic test mode; blind validation harness | Amend opponent contracts rather than fork selection logic if possible |
