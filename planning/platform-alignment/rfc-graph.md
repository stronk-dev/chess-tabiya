...
| F2 | **Semantic evidence and selector — DRAFTED 2026-08-21 as `semantic-evidence-selection.md`** | R1–R2/A3, O2–O3, F1 accepted — **all complete** | Typed sign/event/operands/squares; exactness/confidence/abstention; counterfactual population; subkind-level admission; critical override/top-k budgets; external validation and non-vacuity fixtures | Follow-up to implemented F1; preserves `measurement-records` independence and current `live-marker-quality` behavior; repairs D630/D631/D633, while D632 migration remains F3 |
