...
| 15 | `capability-watch.json` | Capability-first competitor register (19 capabilities, 22 products) | Machine-readable register replacing the 62-product matrix as the watch instrument | LANE OPENED | no RFC — `planning/platform-alignment/capability-watch/plan.md` | none |
...
| 23 | `competitor-matrix.csv` | Living 62-product feature matrix | Register, superseded as *watch* instrument by `capability-watch.json` | LANE OPENED | no RFC — `planning/platform-alignment/capability-watch/plan.md` | none |
