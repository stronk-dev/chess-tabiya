...
| R3 | **MECHANICAL/DESK/RESPONSIVE PROTOTYPE DONE; PARTICIPANT PROTOCOL READY 2026-08-20; EXTERNAL to complete** | **Evidence presentation** — `design/research/evidence-presentation.md`; `planning/platform-alignment/evidence-presentation/participant-plan.md` | Source/corpus audit measured 54 primary controls and a one-square tail of 11 captions/19 marks; the board and LLM paths both bypass R2. Nine modules, five presets and six workflow ceilings pass 17 synthetic tests; the responsive artifact exercises Support, theory-only, honest empty/unavailable and advanced dispositions. D617–D619 settle the architecture/pre-commit boundary. The shipped board remains an invalid production baseline while D537/D573 remain. | Completion still requires 12 nontechnical participants across desktop/phone/keyboard to start named workflows without source settings and meet the predeclared comprehension/noise/leakage rules; candidates are then supported or refused. | Exact preset/module defaults; assistance RFC gate. |
...
| R14 | **PROTOCOL READY; experiential arms BLOCKED by D537/D573 and real admitted R3 packets** | **Campaign closure** — `planning/campaign-research-queue.md`; `planning/platform-alignment/campaign/participant-plan.md` | The stale fixture-run premise and over-broad R6/R7 rows are corrected. The preregistered three-phase owner pilot tests R8 core-loop pull, one explicit retry-count denial and one allowed-vs-suppressed module pair without inventing campaign product state. | Campaign R6–R8 answered and `design/06-campaign.md` either survives, narrows or is returned for amendment before any campaign RFC. | Campaign/progression RFC or explicit deferral. |
