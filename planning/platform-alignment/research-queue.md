...
The safe research frontier is now R5, R11, R12 and R18. R3's mechanical/desk arm is done but its
interaction/participant exit remains external; R4 is done; R8 waits on R3's remaining exit.
