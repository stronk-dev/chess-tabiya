...
| ID | Status | Research deliverable | Method and population | Exit criterion | Unlocks |
|---|---|---|---|---|---|
| R11 | **MECHANICAL DONE; 42-BRANCH BLIND PACKET READY 2026-08-20; EXTERNAL review to complete** | **Bot policy and human-likeness** — `design/research/bot-policy.md` | Reproduced sampling, bounded-error, trait, book and repeat transforms over 837 fixed cells, then generated/validated matched 12-ply continuations across six roots and three strata. Raw Maia, guard 250 and pawn ×4 enter review with weakened Stockfish as negative control; authored-spine and statistical-book arms refuse at 79.2% fallback each. | H5/C5 remain unmet until the preregistered reviewers judge the 42 blind branches and ≥80% of a candidate arm passes every cut. “Personality” that only changes prose remains refused. | O8/F8 stay blocked only by reviewer recruitment/scoring; the legal packet, key and scorecard are committed. |
