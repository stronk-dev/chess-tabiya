...
| R3 | **MECHANICAL/DESK/RESPONSIVE/REAL-F2-PACKET DONE; external participant arm DESCOPED by D649; owner-use validation remains** | **Evidence presentation** — `design/research/evidence-presentation.md`; `planning/platform-alignment/evidence-presentation/participant-plan.md` | Nine modules, five presets and six workflow ceilings pass 19 checks. Three sealed F2 fixtures evaluate 55/55 alternatives and carry five exact facts into the prototype without grades; D686 proves spare cap still admits exact-but-unhelpful generic facts, so F5 needs module-specific eligibility before selection. D537/D573 and accessible-board-input repair the input baseline. | No recruited panel remains. The real-packet owner-use protocol is now executable; browser visual recheck was unrun because no browser surface was connected. | Exact preset/module eligibility/defaults; assistance RFC gate. |
...
| ID | Status | Research deliverable | Method and population | Exit criterion | Unlocks |
|---|---|---|---|---|---|
| R11 | **MECHANICAL + DESK COMPLETE 2026-08-20; owner use remains by D649** | **Bot policy and human-likeness** — `design/research/bot-policy.md` | Reproduced sampling and five transforms over 837 cells, then generated/validated 42 matched 12-ply continuations. Guard 250 and pawn ×4 pass mechanical gates; forcing/quiet fail; authored/statistical books refuse at 79.2% fallback. D649 descopes recruited blind review; packet remains for owner use. | Architecture may distinguish measured policy behavior without claiming population-level “human-like.” Owner blind use is the experiential check. | O8 ready; F8. |
