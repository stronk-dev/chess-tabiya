...
- UX is **an architectural rebuild, not polish**: 569 distinct items; 260 buildable now, 61 waiting
  on a ruling, 116 on an RFC, 108 done, and 24 stale/wrong. Panels still stack above/between content,
...
260 queued, 61 owner-blocked, 116 RFC-blocked, 108 complete and 24 retired items, with zero live
