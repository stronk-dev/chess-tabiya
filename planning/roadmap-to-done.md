...
under an internal “run history” label. Explicit Chess960 PGNs are regression-bound to refuse before
standard-chess state can be persisted. Guest claim, complete inventory-derived labels, portable
