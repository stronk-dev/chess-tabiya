...
- UX is **an architectural rebuild, not polish**: 569 distinct items; 264 buildable now, 61 waiting
  on a ruling, 116 on an RFC, 104 done, and 24 stale/wrong. Panels still stack above/between content,
...
264 queued, 61 owner-blocked, 116 RFC-blocked, 104 complete and 24 retired items, with zero live
