...
- UX is **an architectural rebuild, not polish**: 569 distinct items; 268 buildable now, 61 waiting
  on a ruling, 116 on an RFC, 100 done, and 24 stale/wrong. Panels still stack above/between content,
...
268 queued, 61 owner-blocked, 116 RFC-blocked, 100 complete and 24 retired items, with zero live
