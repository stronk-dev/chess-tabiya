...
- During closeout, a concurrent ledger commit (`aa7f2ba`) consumed the shared Git index after this lifecycle had been staged, so it contains the implementation and archival changes alongside its D49 ledger correction. Shared history was preserved; this append-only note records the mixed checkpoint rather than rewriting it.
