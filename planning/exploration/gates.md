...
|---|---|---|---|---|
| E1 | Competitive teardown confirms meaningful integrated-loop whitespace | Q1a | **met, narrowed** (owner ruling 2026-08-12: desk evidence sufficient; 2026-09-07 recheck reconciled both disputed records and removed three absence inferences. Chessiverse's retained Guided Play continuations/PGN variations/theory handoff are explicit vendor claims, while signed-in interaction remains unobserved. Chessfeed.ai retains and compares analysis-tree branches in a saved study, not played attempts or checkpoint rewinds. Chessigma's attempt persistence/model species, Dr. Wolf's Undo retention and Noctie's Takeback retention are undisclosed; Chess.com's Retry is platform/rollout-dependent rather than universally one ply. None now bears a negative fact. Branch storage/theory handoff are not whitespace individually. No checked competitor yet establishes Tabiya's full grounded cross-workflow integration or preserved N-way played-consequence comparison; reopen on hands-on contradiction) | `design/research/teardown-cet.md`, `teardown-noctie-desk.md`, `teardown-chessable-desk.md`, `teardown-chesscom-desk.md`, `design/research/integrated-platform-alignment.md`, `design/research/competitor-love-hate-sweep.md`, `design/research/ux-core-loop.md` |
...
| E4 | At least one runnable opponent policy produces sufficiently believable multi-ply resistance for a slice | Q5 | unmet | — | **R4 note 2026-08-15 (`design/research/practical-difficulty-outside-tablebase.md`): status unchanged (unmet), but `practical_resistance` is known to be bounded to decided positions. D457 rerun 2026-09-01 (`design/research/dtz-selector-census-rerun.md`): `perfect_tablebase` is reproducibly outcome-preserving and DTZ-directed, with no demonstrated residual hash-tiebreak bias; this is exactness evidence, not believable-resistance evidence. D375/D490 rerun 2026-09-01 (`design/research/practical-resistance-reach.md`): current `practical_resistance` selects 14/40 exact roots and honestly refuses 26/40, with reach 0/22 win, 10/12 loss, 4/6 draw; this establishes a conditional objective and [[D2474]] composition gap, not believable multi-ply play. Status remains unmet.**
...
| B4 | Evidence: authored, Stockfish, Maia, corpus, Syzygy, features, LLM-rendered layers with timing controls | authored ✓, Stockfish ✓, Maia ✓, **corpus/recency ✓ (`runtime-corpus-evidence`)**, structural mechanics ✓ (B9), voice seam ✓. **Feedback Stage 1 (2026-08-21):** **98/196 evidence-admitted, 98/196 evidence-withheld; 69/98 admitted claims render across 32/50 packs and 29/98 remain timing-withheld**. **F1/F2 update (2026-08-21):** the compiled contract now closes at **20 producers / 126 projections / 25 consumers / 175 bindings**, plus 33 operand-preserving semantic events, 33 research eligibility rows, 15 reasons and one complete-local-population policy. Exact source adapters and one rendering authority ship. **D2144–D2147 qualification (2026-08-30):** “exact adapter” proves named construction, not generally payload equality. Corrected census: 75 generic payload adapters / 51 bound; 191 production mint routes / 187 projection ids; four duplicate-route projections; six manifest projections with no route. The literal syntax-aware receipt finds 184 used routes, seven export-only routes and zero bound projections without a production mint use; the rejected direct-call probe had falsely reported 25/19 by missing callbacks. Four false readings remain product-inert only because they have no consumer; an impossible castling-loss event reaches the research selector. The 20-row rules/position-exact class splits 9 literal totals / 6 exact-under-convention computations / 2 product classifiers / 3 mixed-authority projections; phase/named-structure need reclassification and endgame/pivotal/structural-result need split identities. Value authority, truthful grounding and route/factory closure must close before Phase-3 learner activation. The first three R3 packets evaluate **55/55 alternatives** and preserve fact IDs/squares into the prototype, while D686 shows research-wide eligibility still admits generic spare-cap facts. R5 keeps deterministic rendering normative and optional LLM prose post-selection. **Hint-selector qualification (2026-08-23):** raw precedence selects an opponent edge in 28/72 non-empty rows; the relation-safe table admits 35/150 occurrences and reaches only 16/64 depth-12 / 10/64 100-ms positions. Its depth-12 selector-only p95 is 1,596 ms before engine/transport/rendering. Perspective/sign research is closed; the current Guided Hint RFC remains returned pending shared-packet E2E measurement, sealed disclosure and owner use. Residual: grounding/value-authority/route closure + Feedback Stage 2 + F5's module-specific eligibility/presets/defaults + owner-use validation; F2 deliberately grants no product-module admission |
...
| B10 | Adaptive guidance: live phase/structure classification in-run, assistance configurable per session context, author-free pivotal detection, endgame steering by named technique | **mechanically shipped; workflow/default and live-selection qualification open.** Attributed phase classification, silent raw preferences, pivotal markers, gated human splits, endgame naming, eval pivots and deterministic voice seam exist. **A5:** six profiles expose 54 mechanism controls but only one unnamed default; permissions are byte-identical across run kinds; only 2/6 intended workflows bind directly; Academy and Story bypass expected addressing. **D52 measurement 2026-09-01:** `human_divergence` fires at an estimated 0.0763/played ply (76.3% of the complete live-union budget), changes label across Maia bands on 22.73% of corpus positions, and its external threshold label improves only 2.26 accuracy points over silence on 133 opening positions. **D53 measurement 2026-09-01:** `option_collapse` fires at 0.00443/played ply in 108 real-game paths and 0/555 authored spans; all 31 real-game firings are repeated-check states, while the high floor is nearly inert and the low ceiling controls volume. **D2483–D2485 measurements 2026-09-01:** the rules phase convention matches 42/48 single-phase pack roots, abstains on 5 and mismatches 1; over 681 authored positions it matches 517, abstains 108 and differs 56. Across all 804 positions its 122 abstentions split into 5 material-gap and 117 development-gap decisions, with 251/682 concrete labels within one operand unit of their selected boundary. The source join adds 132 exact opening endpoints, 204 catalogue memberships, 109 typed endgames and 241 recorded tablebase positions without merging them: membership overlaps 70 unclear and 30 middlegame rules readings, exits 49 times and re-enters 14 across 100 paths. All 31 KRPvKR positions currently receive both Lucena and Philidor labels from material alone, so named-technique steering is specifically not qualified. **D2495–D2497 narrow the named-technique contract:** source-bounded setup intersections match only 4/31 Lucena and 6/31 Philidor positions; the corpus has zero Vancura population. Across 100 authored paths, only 3 Lucena + 3 Philidor method stages fire, all six preserve the beneficiary's recorded tablebase result, and one path witnesses setup arrival. Three complete one-ply roots prove distinct readings under exact beneficiary-WDL preservation: Lucena possible/not-forceable/not-inevitable; Philidor possible/forceable/not-inevitable; Vančura possible/forceable/inevitable. Unsnapshotted branches of an unbounded claim remain unknown. No production multi-ply reachability provider exists. Material class, cited setup, witnessed method stage, quantified reachability and perspective-oriented tablebase outcome remain separate identities. This is deterministic source-local evidence, not Q4c's independent position truth or calibrated confidence; the product payload/composition still awaits accepted RFCs and implementation. Thus “configurable” is true only at the mechanism layer, and “author-free pivotal/phase” does not yet mean measured-useful or properly composed |
