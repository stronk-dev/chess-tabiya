...
| B2 | Solo modes: Just Play + Line/Plan/Outcome/Trajectory each complete one fixture run | shipped 2026-08-13 — Plan, Line (`line-drill-theory-grading`), Outcome (`outcome-drill-grading`), organic+guided Trajectory (`trajectory-drill`) and pack-less Just Play (F2) each with fixture/browser runs |
