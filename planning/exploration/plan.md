...
| Q4c | Can automatic phase/structure recognition support Just Play without pretending certainty? | 📊 partial 2026-08-20 — R1 `design/research/detection-landscape.md` settles the producer boundary: six evidence planes; exact atoms separated from semantic events; multi-ply threats require declared search/policy; theory/author claims cannot be manufactured. Four cheap tactic probes fail semantic precision against 50,000 Lichess records. Selection/sign (R2), presentation (R3) and reader validation remain open | B2, B4 |
