...
| Q4c | Can automatic phase/structure recognition support Just Play without pretending certainty? | 📊 partial 2026-09-01 — R1 settles the producer boundary; R2 settles selection; R3 proves board lighting and the old LLM packet bypass those gates. D2483 measures the shipped rules convention; D2484 resolves its five typed decision arms and exact threshold sensitivity. D2485 now resolves downstream composition: 804 exact-node source vectors and 100 paths prove opening membership overlaps unclear/middlegame rules readings, exits 49 times and re-enters 14, so opening, rules phase, endgame and tablebase must remain independently attributed source slots plus source-local history—not one “true phase.” This is still not calibrated confidence or independent position truth. Semantic family admission, position labels/error costs, valid touch/keyboard interaction and nontechnical reader/preset validation remain open | B2, B4 |
