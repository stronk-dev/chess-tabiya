...
| Q4c | Can automatic phase/structure recognition support Just Play without pretending certainty? | 📊 partial 2026-08-20 — shipped recognition is a present-position geometric census, not the semantic/multi-ply classifier the guidance vision assumes; selection/sign are as important as adding motifs. `design/research/integrated-platform-alignment.md`; detection landscape and UX validation remain open | B2, B4 |
