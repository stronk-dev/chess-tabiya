...
| Q4c | Can automatic phase/structure recognition support Just Play without pretending certainty? | 📊 partial 2026-09-01 — R1 settles the producer boundary; R2 settles selection; R3 proves board lighting and the old LLM packet bypass those gates. D2483 adds the first shipped-phase corpus reading: single-phase roots 42/48 match, 5 abstain, 1 mismatch; all authored positions 517/681 match, 108 abstain, 56 differ; 39 edge changes have zero two-edge reversals. This is curated-pack consistency, not independent position truth. Semantic family admission, typed phase reason/margin, source-retaining phase composition, position labels/error costs, valid touch/keyboard interaction and nontechnical reader/preset validation remain open | B2, B4 |
